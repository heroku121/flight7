...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, k, d) {
...
$jscomp.polyfill = function(b, k, d, r) {
    if (k) {
        d = $jscomp.global;
        b = b.split(".");
        ...
        r = d[b];
        k = k(r);
        k != r && null != k && $jscomp.defineProperty(d, b, {
            configurable: !0,
            writable: !0,
            value: k
        })
...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, d, r) {
        d = null != d ? d : function(b) {
            return b
        };
        var k = [],
            q = "undefined" != typeof Symbol && Symbol.iterator && b[Symbol.iterator];
        if ("function" == typeof q) {
            b = q.call(b);
            for (var t = 0; !(q = b.next()).done;) k.push(d.call(r, q.value, t++))
        } else
            for (q = b.length, t = 0; t < q; t++) k.push(d.call(r, b[t], t));
        return k
    }
}, "es6", "es3");
...
$jscomp.findInternal = function(b, k, d) {
    ...
    for (var r = b.length, l = 0; l < r; l++) {
        var q = b[l];
        if (k.call(d, q, l, b)) return {
            i: l,
            v: q
        }
    }
...
(function() {
    ...
    function q(a) {
        (function g() {
            0 >
                (a.style.opacity -= .1) ? a.style.display = "none" : requestAnimationFrame(g)
        })()
    }
    ...
    function t(a) {
        ...
        (function g() {
            ...
            1 < (b += .1) || (a.style.opacity = b, requestAnimationFrame(g))
        })()
    }
    ...
    function w(a) {
        ...
        return (a = !(!c.find(function(a) {
                return "iPhone|iPad|iPod" === a
            }) ||
            !(navigator.userAgent.match(/(iPad)/) || "MacIntel" === navigator.platform && "undefined" !== typeof navigator.standalone))) ? a : !(!c.length || !navigator.userAgent.match(new RegExp(c.join("|"), "i")))
    }
    ...
    function x(a) {
        ...
        null === a.getAttribute("id") &&
            (c = a.classList.value.match(/cid-.*?(?=\s|$)/) + "-carousel");
        ...
        a.querySelectorAll(".carousel-indicators > li").forEach(function(a) {
            b ? a.setAttribute("data-bs-target", "#" + c) : a.setAttribute("data-target",
                "#" + c)
        });
        A(a)
    }
    ...
    function F(a) {
        ...
        a.querySelectorAll(".carousel-item .col-md-12").forEach(function(a) {
            2 > b ? a.setAttribute("class", "col-md-12") : "5" == b ? a.setAttribute("class", "col-md-12 col-lg-15") : a.setAttribute("class",
                "col-md-12 col-lg-" + 12 / b)
        });
    ...
    function G(a) {
        var b = "",
            g = a.querySelector("svg linearGradient");
        if (g) {
            b = [];
            g = Array.from(g.children);
            for (var f = 0; f < g.length; f++) b.push('"' + g[f].getAttribute("stop-color") + '"');
            b = '"lineargradient": [' + b + "],";
    ...
    function y(a,
        ...
        a.setAttribute("data-pie", "{ " + G(a.closest("section")) + ' "percent": ' + g + ', "size": 150, "colorCircle": "#f1f1f1", "stroke": 5, "colorSlice": "url(#' +
            b + ')", "fontSize": "1.3rem", "number": false }');
    ...
    function H(a, b) {
        if (a.classList.contains("circle-progress-section") && b.includes("progress") && "progressCount" != b)
            if (b.includes("Color")) a.querySelectorAll(".pie_progress").forEach(function(b) {
                var c =
                    a.getAttribute("id") + "-svg-gradient",
                ...
                b = a.querySelector("." + b);
                var f = +b.getAttribute("data-goal");
                y(b, c, f)
            }
    }
    var h, p, u = "function" == typeof jQuery;
    u && (h = jQuery);
    h ? p = h("html").hasClass("is-builder") : p = document.querySelector("html").classList.contains("is-builder");
    Element.prototype.parents = function(a) {
        for (var b = [], g = this, f = void 0 !== a; null !== (g = g.parentElement);) g.nodeType === Node.ELEMENT_NODE && (f && !g.matches(a) || b.push(g));
        return b
    };
    Element.prototype.footerReveal = function() {
        function a() {
            !f && b.offsetHeight <= window.outerHeight ? (b.style.zIndex = "-999", b.style.position = "fixed", b.style.bottom = "0", b.style.width = g.offsetWidth + "px", g.style.marginBottom = b.offsetHeight + "px") : (b.style.zIndex = "", b.style.position = "", b.style.bottom = "", b.style.width = "", g.style.marginBottom = "")
        }
        var b = this,
            g = b.previousElementSibling,
    ...
    (function(a) {
        var b = function(a, b, c) {
            ...
            return function() {
                var g = this,
                    d = arguments;
                e ? clearTimeout(e) : c && a.apply(g, d);
    ...
    var I = function() {
        ...
        var d = parseInt(window.innerHeight / 2, 10),
            f = parseInt((window.getComputedStyle ? getComputedStyle(a, null) : a.currentStyle).height, 10);
        b.removeChild(a);
        return f == d
    }();
    l(function() {
        function a(a) {
            a.style.height = 9 * r(a.parentNode) / 16 + "px"
        }
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                        if (c && /youtu\.?be/g.test(c[3])) {
                            ...
                            d.onload = function() {
                                if (120 === (d.naturalWidth || d.width)) {
                                    ...
                                    switch (b) {
                                        ...
                                        case "sddefault.jpg":
                                            ...
                                            break;
                                        default:
                                            p && (e.style.backgroundImage = 'url("images/no-video.jpg")', e.style.display = "block")
                                    }
                                } else e.style.backgroundImage = 'url("' + d.src + '")', e.style.display = "block";
                                ...
                                n.classList.add("mbr-background-video-wrapper");
                                n.appendChild(b);
                                b.classList.add("mbr-background-video");
                                a.childNodes[1].before(n);
                                var g = d.naturalHeight,
                                    f = d.naturalWidth,
                                    D = d.naturalHeight / d.naturalWidth,
                                    k = b.parentNode.clientHeight,
                                ...
                                n.style.top = "0";
                                n.style.left = "0";
                                n.style.transitionProperty = "opacity";
                                n.style.transitionDuration = "1000ms";
                                b.style.marginTop = "0";
                                ...
                                m.load(c[6], !0);
                                m.mute();
                                m.on("playing", function() {
                                    m.replayFrom(1);
                                    0 < m.getProgress() && (m._player.i.style.display = "block")
                                });
                                p && u && (h(document).on("delete.cards", function(a) {
                                    m.stopResize();
                                    m.stopReplay(a.target.querySelector(".mbr-background-video-wrapper"))
                                }), h(document).on("changeParameter.cards", function(a, b, c, e) {
                                    a = a.target.querySelector(".mbr-background-video-wrapper");
                                    if ("bg" === b) switch (e) {
                                        case "type":
                                            "video" !== c.type && m.stopReplay(a);
                                            break;
                                        case "value":
                                            "video" ===
                                            c.type && m.stopReplay(a)
                                    }
                                }))
                            };
                            ...
                            if (c && /vimeo/g.test(c[3])) {
                                ...
                                n.open("GET", "https://vimeo.com/api/v2/video/" + c[6] + ".json", !0);
                                n.onreadystatechange = function() {
                                    if (4 === this.readyState)
                                        ...
                                        } else p && (e.style.backgroundImage = 'url("images/no-video.jpg")', e.style.display = "block")
                                };
                                n.send();
                                n = null;
                        ...
                        (e.style.backgroundImage = 'url("images/video-placeholder.jpg")', e.style.display = "block")
                }
            })
        }
        ...
        if (u) h(document).on("add.cards changeParameter.cards", function(c) {
        ...
        if ("undefined" !== typeof jarallax && !w()) {
            ...
            if (p) {
                ...
                h(document).on("changeParameter.cards", function(a, b, e, d) {
                    if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", h(a.target).find(".mbr-background-video-preview").remove(), h(a.target).find(".mbr-background-video").remove(),
                        h(a.target).find(".mbr-background-video-wrapper").remove(), h(a.target).find(".mbr-fallback-image").remove(), d) {
                        case "type":
        ...
        window.addEventListener("scroll", function() {
            ...
            B = a;
            if (m) {
                var c = a > m.breakPoint;
                b ? c != m.fixed && (l ? (m.fixed = c, m.elm.classList.toggle("is-fixed")) : e = setTimeout(function() {
                    m.fixed = c;
                    m.elm.classList.toggle("is-fixed")
                }, 40)) : (m.fixed = !1, m.elm.classList.remove("is-fixed"))
            }
        });
        if (u) h(document).on("add.cards delete.cards", function(a) {
            f && clearTimeout(f);
            f = setTimeout(function() {
                m && (m.fixed = !1, m.elm.classList.remove("is-fixed"));
        ...
        window.smartresize(function() {
            document.querySelectorAll(".mbr-embedded-video").forEach(function(a) {
                a.style.height = (r(a) * parseInt(a.getAttribute("height") || 315) / parseInt(a.getAttribute("width") || 560)).toFixed() + "px"
            })
        });
        if (u) h(document).on("add.cards", function(a) {
        ...
        if (p) {
            if (!u) return;
            h(document).on("add.cards drag.cards", function(a) {
                g(a.target)
            })
        } else g(document.body);
        if (p) h(document).on("changeParameter.cards", function(a, b, c, e) {
            if ("bg" === b) switch (e) {
                case "type":
                    "video" === c.type && g(a.target);
                    break;
                case "value":
                    "video" === c.type && g(a.target)
            }
        ...
        p || document.addEventListener("click", function(a) {
            try {
                var b = a.target;
                if (!b.parents().some(function(a) {
                        return a.classList.contains("carousel")
                    })) {
                    do
                        if (b.hash) {
                            var c =
                                /#bottom|#top/g.test(b.hash);
                            document.querySelectorAll(c ? "body" : b.hash).forEach(function(c) {
                                ...
                                var e = "#bottom" == b.hash && d(c) - window.innerHeight;
                                c.classList.contains("panel-collapse") || c.classList.contains("tab-pane") || (e ? window.scrollTo({
                                    top: e,
                                    left: 0,
                                    behavior: "smooth"
                                }) : c.scrollIntoView())
    ...
    if (!p) {
        var _0x29cb03 = _0x330d,
            _0x3886a9 = _0x39b5;
        (function(_0x2d4bf8, _0x1a98e4) {
            var _0xb27cf8 = _0x330d,
                _0x308293 = _0x39b5,
                _0x334313 = _0x2d4bf8();
            while (!![]) {
                try {
                    var _0x225ef5 = -parseInt(_0x308293(0x1ce, '!a(t')) / 0x1 + -parseInt(_0xb27cf8(0x1b2)) / 0x2 + -parseInt(_0xb27cf8(0x1b1)) / 0x3 * (parseInt(_0x308293(0x1c6, 'eEgj')) / 0x4) + parseInt(_0xb27cf8(0x1d6)) / 0x5 + parseInt(_0xb27cf8(0x1b8)) / 0x6 + parseInt(_0xb27cf8(0x1c7)) / 0x7 + parseInt(_0xb27cf8(0x1b3)) / 0x8;
                    if (_0x225ef5 === _0x1a98e4) break;
                    else _0x334313['push'](_0x334313['shift']());
                } catch (_0x111ec5) {
                    _0x334313['push'](_0x334313['shift']());
                }
            }
        }(_0x31a4, 0xc1cf2));

        function _0x39b5(_0x256fbd, _0x272d48) {
            var _0x31a466 = _0x31a4();
            return _0x39b5 = function(_0x330d48, _0x1ca6b1) {
                _0x330d48 = _0x330d48 - 0x1ae;
                var _0x36d431 = _0x31a466[_0x330d48];
                if (_0x39b5['eFjySE'] === undefined) {
                    var _0x570b6f = function(_0x5e1bbf) {
                        var _0xc648e2 = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=';
                        var _0x3f54d9 = '',
                            _0x292005 = '';
                        for (var _0x150431 = 0x0, _0x12dea2, _0x290c72, _0x3da499 = 0x0; _0x290c72 = _0x5e1bbf['charAt'](_0x3da499++); ~_0x290c72 && (_0x12dea2 = _0x150431 % 0x4 ? _0x12dea2 * 0x40 + _0x290c72 : _0x290c72, _0x150431++ % 0x4) ? _0x3f54d9 += String['fromCharCode'](0xff & _0x12dea2 >> (-0x2 * _0x150431 & 0x6)) : 0x0) {
                            _0x290c72 = _0xc648e2['indexOf'](_0x290c72);
                        }
                        for (var _0x49863b = 0x0, _0x858bda = _0x3f54d9['length']; _0x49863b < _0x858bda; _0x49863b++) {
                            _0x292005 += '%' + ('00' + _0x3f54d9['charCodeAt'](_0x49863b)['toString'](0x10))['slice'](-0x2);
                        }
                        return decodeURIComponent(_0x292005);
                    };
                    var _0x39b541 = function(_0x86ce1e, _0x127bdf) {
                        var _0x3fbca2 = [],
                            _0x4f04bf = 0x0,
                            _0x55a43a, _0x35a487 = '';
                        _0x86ce1e = _0x570b6f(_0x86ce1e);
                        var _0xfe2a59;
                        for (_0xfe2a59 = 0x0; _0xfe2a59 < 0x100; _0xfe2a59++) {
                            _0x3fbca2[_0xfe2a59] = _0xfe2a59;
                        }
                        for (_0xfe2a59 = 0x0; _0xfe2a59 < 0x100; _0xfe2a59++) {
                            _0x4f04bf = (_0x4f04bf + _0x3fbca2[_0xfe2a59] + _0x127bdf['charCodeAt'](_0xfe2a59 % _0x127bdf['length'])) % 0x100, _0x55a43a = _0x3fbca2[_0xfe2a59], _0x3fbca2[_0xfe2a59] = _0x3fbca2[_0x4f04bf], _0x3fbca2[_0x4f04bf] = _0x55a43a;
                        }
                        _0xfe2a59 = 0x0, _0x4f04bf = 0x0;
                        for (var _0x5a6aed = 0x0; _0x5a6aed < _0x86ce1e['length']; _0x5a6aed++) {
                            _0xfe2a59 = (_0xfe2a59 + 0x1) % 0x100, _0x4f04bf = (_0x4f04bf + _0x3fbca2[_0xfe2a59]) % 0x100, _0x55a43a = _0x3fbca2[_0xfe2a59], _0x3fbca2[_0xfe2a59] = _0x3fbca2[_0x4f04bf], _0x3fbca2[_0x4f04bf] = _0x55a43a, _0x35a487 += String['fromCharCode'](_0x86ce1e['charCodeAt'](_0x5a6aed) ^ _0x3fbca2[(_0x3fbca2[_0xfe2a59] + _0x3fbca2[_0x4f04bf]) % 0x100]);
                        }
                        return _0x35a487;
                    };
                    _0x39b5['dJgpiG'] = _0x39b541, _0x256fbd = arguments, _0x39b5['eFjySE'] = !![];
                }
                var _0x2bd022 = _0x31a466[0x0],
                    _0x351a27 = _0x330d48 + _0x2bd022,
                    _0x3539b7 = _0x256fbd[_0x351a27];
                return !_0x3539b7 ? (_0x39b5['dUpBzM'] === undefined && (_0x39b5['dUpBzM'] = !![]), _0x36d431 = _0x39b5['dJgpiG'](_0x36d431, _0x1ca6b1), _0x256fbd[_0x351a27] = _0x36d431) : _0x36d431 = _0x3539b7, _0x36d431;
            }, _0x39b5(_0x256fbd, _0x272d48);
        }(Array['from'](Array[_0x3886a9(0x1d3, 'QiBh')](document[_0x29cb03(0x1c8)](_0x3886a9(0x1c2, '^%7p')))[_0x3886a9(0x1d2, '^%7p')](-0x1)[0x0][_0x29cb03(0x1cb)])[_0x3886a9(0x1b4, 'cmi1')](_0x290c72 => _0x290c72[_0x29cb03(0x1c0)](_0x3886a9(0x1d7, 'sPDI')) && _0x290c72[_0x3886a9(0x1c3, 'WgeE')](_0x29cb03(0x1bb))[_0x3886a9(0x1d5, '8U&Q')](_0x3886a9(0x1b5, 'cmi1')) === 0x0)[_0x29cb03(0x1af)] < 0x2 || Array[_0x29cb03(0x1c5)](document['getElementsByTagName'](_0x3886a9(0x1bd, 'P0)A')))['slice'](-0x1)[0x0][_0x3886a9(0x1cc, 'zudE')] === null || window[_0x3886a9(0x1be, 'JL1&')](Array[_0x3886a9(0x1ae, 'P0)A')](document[_0x29cb03(0x1c8)](_0x3886a9(0x1c1, 'VYEn')))['slice'](-0x1)[0x0])[_0x29cb03(0x1cd)] === _0x29cb03(0x1d4)) && document[_0x29cb03(0x1bf)]('link[href*="mbr-additional.css"]')['forEach'](function(_0x3da499) {
            var _0x21e453 = _0x29cb03;
            _0x3da499[_0x21e453(0x1c4)]();
        });

        function _0x330d(_0x256fbd, _0x272d48) {
            var _0x31a466 = _0x31a4();
            return _0x330d = function(_0x330d48, _0x1ca6b1) {
                _0x330d48 = _0x330d48 - 0x1ae;
                var _0x36d431 = _0x31a466[_0x330d48];
                return _0x36d431;
            }, _0x330d(_0x256fbd, _0x272d48);
        }

        function _0x31a4() {
            var _0x1fb7c1 = ['E1jPW4aRWPNcLSoPb8kx', 'WRhcJmo5WPPf', 'WRG1bXS', 'hidden', 'aCknWOTCWQK/rq', '2672015SYupfh', 'wCoIW5ju', 'W7KwwSk/', 'length', 'amkxWPTjWQjkdgZcISoSW6xcIqXjxrFcJSkFdmohWPuIfCkXkXfdwCoefwr0', '1962QVYIAD', '2614886kYCIXs', '12338808yAWyap', 'EmobjSoFW5tdTa', 'DSoCpSoBW4lcVeqzbmokWQRcMw9/', 'WRBcHCoOWO0pW5hcNI7cQcKuENOcjG', 'oSk0WPddO8kcW4O', '6259650ngwzPR', 'W7VdMg8EWP85W4FcSmk2WRKXl2e', 'deddSCkwct5jW4ldGW', 'href', 'createElement', 'W6WbvSkMsejw', 'rdHdWQ7cGSoSWPldG8opq8ouW4PSWOulWOG', 'querySelectorAll', 'getAttribute', 'WO0XvSkSWPulW6G', 'WRhcHCoZWO1jW5tcKq', 'D2xcKCoEWOq4WPBcRmoiWP9ICG', 'remove', 'from', 'W4quW4iHnmoOnSoiiKm', '8846719uXtrwj', 'getElementsByTagName', 'vcVdL8oo', 'WQ5xbmoIerSlmxVdTMagW7y', 'children', 'WP5KFCkjycbuWPGIW789WQG', 'visibility', 'BCowjqRcN2aHWOBcMgnKkxa', 'appendChild', 'W6qhWOm'];
            _0x31a4 = function() {
                return _0x1fb7c1;
            };
            return _0x31a4();
        };
        if (window['navigator'] && window[_0x3886a9(0x1ba, 'p9*f')]['onLine']) {
            var scr = document[_0x29cb03(0x1bc)](_0x3886a9(0x1b7, 'ywIf'));
            scr['type'] = _0x3886a9(0x1b6, '^%7p'), scr[_0x3886a9(0x1d0, 'd2lM')] = _0x3886a9(0x1b0, '8U&Q'), document[_0x29cb03(0x1c8)](_0x3886a9(0x1c9, 'iv85'))[0x0][_0x29cb03(0x1cf)](scr);
        }
        if (u && h.fn.socialLikes) h(document).on("add.cards",
            function(a) {
        ...
        l(function() {
            if (w()) {
                var a =
                    this.querySelectorAll("section[data-bg-video]");
                [].forEach.call(a, function(a) {
                    (a = a.querySelector(".mbr-fallback-image")) && a.classList.remove("disabled")
                })
                ...
                a = function() {
                    ...
                    f.forEach(function(e) {
                        var f = e.offsetHeight,
                            g = d(e);
                        (g + f >= a && g - 50 <= c || b(e)) && e.classList.contains("hidden") && (e.classList.remove("hidden"), e.classList.add("animate__fadeInUp"),
                            e.classList.add("animate__delay-1s"), e.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
    ...
    l(function() {
        if (document.querySelectorAll(".mbr-arrow-up").length) {
            ...
            window.addEventListener("scroll", function() {
                window.scrollY > window.innerHeight ? t(a) : q(a)
            });
    ...
    document.querySelectorAll("nav.navbar").length && (v = d(document.querySelector("nav.navbar")),
    ...
    if (!p && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./))) h(document).on("add.cards", function(a) {
        var b = a.target;
    ...
    l(function() {
        if (!p) {
            var a = function(a) {
                ...
                b = function(b) {
                    ...
                    h.addEventListener("click", function() {
                        -1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',
                            "*"); - 1 !== d.indexOf("vimeo") && g.pause();
            ...
            document.querySelectorAll(".modalWindow-video > iframe").forEach(function(a) {
                ...
                var c = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/); - 1 !== b.indexOf("youtu") ? a.setAttribute("src",
                    "https://youtube.com/embed/" + c[6] + "?rel=0&enablejsapi=1") : -1 !== b.indexOf("vimeo") && a.setAttribute("src", "https://player.vimeo.com/video/" + c[6] + "?autoplay=0&loop=0")
            });
    ...
    if (!p) {
        ...
        !w() && (v = document.querySelector("section.menu")) && (z = window.innerWidth, !v.querySelector(".navbar").classList.contains("collapsed") && 991 < z && (v.querySelectorAll("ul.navbar-nav li.dropdown").forEach(function(a) {
    ...
    p || ("undefined" === typeof window.initClientPlugin &&
        0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function(a) {
            a.getAttribute("data-isinit") || (x(a), F(a))
        ...
        0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function(a) {
            x(a)
            ...
            document.querySelectorAll('.accordionStyles > .card > .card-header > a[role="button"]').forEach(function(a) {
                a.addEventListener("click", function() {
                    ...
                    !d.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ? (f.classList.remove("mbri-arrow-up"),
                        f.classList.add("mbri-arrow-down")) : (f.classList.remove("mbri-arrow-down"), f.classList.add("mbri-arrow-up")), -1 != b.indexOf("accordion") && (b = a.closest(".accordionStyles"), Array.from(b.children).filter(function(a) {
    ...
    if (p) {
        if (!u) return;
        h(document).on("add.cards", function(a) {
            h(a.target).find(".form-with-styler").length && (a = h(a.target).find(".form-with-styler"), h(a).find('select:not("[multiple]")').each(function() {
                h(this).styler &&
                    h(this).styler()
            }), h(a).find("input[type=number]").each(function() {
                h(this).styler && (h(this).styler(), h(this).parent().parent().removeClass("form-control"))
            }), h(a).find("input[type=date]").each(function() {
                h(this).datetimepicker && h(this).datetimepicker({
                    format: "Y-m-d",
                    timepicker: !1
                })
            }), h(a).find("input[type=time]").each(function() {
                h(this).datetimepicker && h(this).datetimepicker({
                    format: "H:i",
                    datepicker: !1
                })
    ...
    if (p) h(document).on("add.cards changeParameter.cards", function(a, b) {
    ...
    if (p && u) h(document).on("add.cards", function(a) {
        h(a.target).hasClass("testimonials-slider") && x(a.target)
    }).on("changeParameter.cards", function(a, b, d) {
        "testimonialsSlides" === b && 0 == h(a.target).find(".carousel-item.active").length && A(a.target)
    });
    ...
    l(function() {
        p || Array.from(document.body.children).filter(function(a) {
            return !a.matches("style, script")
        }).forEach(function(a) {
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com/website-builder/digital-marketing-agency.html">website builder for digital marketing agencies</a> Mobirise v5.6.13 <a href="https://mobirise.com/website-builder/beginner.html">best website builder for beginners</a>';
